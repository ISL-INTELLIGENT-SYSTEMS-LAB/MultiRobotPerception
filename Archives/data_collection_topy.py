...
if __name__ == "__main__":
    ...
    zed = sl.Camera()
    print("correctly running")
    dir_path = "/home/mrrobot/Documents/ISL-Projects-main/TurtlebotZED/data_collection/9-26-23"
    EXPERIMENT = 'test_1'
   ...
   # Configure object detection runtime parameters
    ...
    keep_going = input('Run another test? (Yes/No) ')
