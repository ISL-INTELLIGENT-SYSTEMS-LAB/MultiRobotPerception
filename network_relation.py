...
def main():
        ...
        final_filepath = nr.root + experiment_name
        nr.files = [filename for filename in os.listdir(final_filepath) if (filename.endswith('.csv') and not filename.startswith('output'))]
        print(nr.network_relation())
